...
export default {
    data() {
      return {
        urlFinales: process.env.BASE_URL + "datas/c1_finales_general.json",
        ...
        loadDataOds() {
            ...
            axios
                ...
                .then(response => {
                  ...
                  for (var i in this.leclassement ) {
                    if (this.leclassement[i].equipe)
                        this.leclassement[i].displayEqui = this.lesequipeskey[this.leclassement[i].equipe]
                    else {
                        this.leclassement[i].displayEqui =  blancEquipe
                    }
                  }
                  ...
                  for (var y in this.lesmatchsNiv3 ) {
                    this.lesmatchsNiv3[y].score = this.lesmatchsNiv3[y].equipeDom.but+" - "+this.lesmatchsNiv3[y].equipeExt.but
                    if (this.lesmatchsNiv3[y].equipeDom.id)
                        this.lesmatchsNiv3[y].displayDom = this.lesequipeskey[this.lesmatchsNiv3[y].equipeDom.id]
                    else {
                        this.lesmatchsNiv3[y].displayDom =  blancEquipe
                    }
                    if (this.lesmatchsNiv3[y].equipeExt.id)
                        this.lesmatchsNiv3[y].displayExt = this.lesequipeskey[this.lesmatchsNiv3[y].equipeExt.id]
                    else {
                        this.lesmatchsNiv3[y].displayExt =  blancEquipe
                    }
                  }
