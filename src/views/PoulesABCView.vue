            ...
            <v-row>
              <v-col>
                <base-material-card color="colorPA" class="px-0"  >
                  ...
                  <div class="display-2 font-weight-light">PouleA-Matchs</div>
                  </template>
              ...
              <v-col>
                <base-material-card color="colorPA" class="px-0"  >
                  <template v-slot:heading>
                      <div class="display-2 font-weight-light">PouleA-Classement</div>
                  </template>
                  <v-card-text class="px-0" >
              ...
              <v-row>
                  <v-col>
                      <base-material-card color="colorPB" class="px-0"  >
                          <template v-slot:heading>
                              <div class="display-2 font-weight-light">PouleB-Matchs</div>
                          </template>
                          <v-card-text class="px-0" >
                  ...
                  <v-col>
                    <base-material-card color="colorPB" class="px-0"  >
                        <template v-slot:heading>
                            <div class="display-2 font-weight-light">PouleB-Classement</div>
                        </template>
                        <v-card-text class="px-0" >
            ...
            <v-row>
                <v-col>
                    <base-material-card color="colorPC" class="px-0"  >
                        <template v-slot:heading>
                            <div class="display-2 font-weight-light">PouleC-Matchs</div>
                        </template>
                        <v-card-text class="px-0" >
                ...
                <v-col>
                    <base-material-card color="colorPC" class="px-0"  >
                        <template v-slot:heading>
                            <div class="display-2 font-weight-light">PouleC-Classement</div>
                        </template>
                        <v-card-text class="px-0" >
...
export default {
    data() {
      return {
        urlPouleA: process.env.BASE_URL + "datas/c1_pouleA.json",
        urlPouleB: process.env.BASE_URL + "datas/c1_pouleB.json",
        urlPouleC: process.env.BASE_URL + "datas/c1_pouleC.json",
    ...
    methods: {
        ...
        loadDataOds() {
            ...
            axios
                .get(urlPouleC)
                .then(response => {
                  this.lesmatchsC = response.data.lesmatchs
                  this.leclassementC = response.data.leclassement

                  for (var n in this.lesmatchsC ) {
                    this.lesmatchsC[n].score = this.lesmatchsC[n].equipeDom.but+" - "+this.lesmatchsC[n].equipeExt.but
                    this.lesmatchsC[n].displayDom = this.lesequipeskey[this.lesmatchsC[n].equipeDom.id]
                    this.lesmatchsC[n].displayExt = this.lesequipeskey[this.lesmatchsC[n].equipeExt.id]
                  }

                  for (var z in this.leclassementC ) {
                    this.leclassementC[z].displayEqui = this.lesequipeskey[this.leclassementC[z].id]
                  }
